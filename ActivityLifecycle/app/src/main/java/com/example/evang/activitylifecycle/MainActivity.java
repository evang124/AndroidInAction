...
/**
 * The main() of android. This class starts the application and draw the UI.
 *  AppCompatActivity allows the app to backwards compatible for past android versions
 *  extra resources:
...
public class MainActivity extends AppCompatActivity {
    ...
    public static String TAG = "Lifecycle Activity"; // a tag to use for debugging purposes, check Logcat when you run this app
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //switch to a new activity, use context to help get access for the app
    ...
    private void changeText(String status) {
        ...
        String currentText = String.format(getResources().getString(R.string.current_lifecycle), current);
